BZFlag Server Plugin: airshotFlag
================================================================================
...
airshotFlag directory to a new name, and then manually replace airshotFlag
...
To load the plugin with specific settings, use the format:
  -loadplugin airshotFlag,<powerlevel>,<meaning>,<leet>
For example:
  -loadplugin airshotFlag,1006,42,1337

To load the plugin and specify a configuration file, use the format:
  -loadplugin airshotFlag,<configfilename>
For example:
  -loadplugin airshotFlag,/path/to/my/sampleplugin.cfg
